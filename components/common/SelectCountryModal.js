...
export const SelectCountryModal = (props) => {
  ...
  const submitCountry = () => {
    ...
    appData.setCountryCode && appData.setCountryCode(selectedCountry.store_code);
    localStorage.setItem('countryCode', selectedCountry.store_code);
  ...
  const handleCountryCode = (country) => {
    if (props.modalType && props.modalType === "first") {
      appData.setCountryCode && appData.setCountryCode(country.store_code);
      localStorage.setItem('countryCode', country.store_code);
    } else {
